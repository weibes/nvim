...
| `<leader>cf` | Format buffer (Prettier via conform.nvim) |

> ESLint auto-fixes on save when the eslint LSP is active.
> Prettier formats on save automatically for JS/TS/JSON files.

---

## TypeScript Tools (`typescript-tools.nvim`)

These only work in JS/TS files.
...
## Debugger (nvim-dap + vscode-js-debug)
